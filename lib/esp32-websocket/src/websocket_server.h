...
#define WEBSOCKET_SERVER_QUEUE_SIZE 16
#define WEBSOCKET_SERVER_QUEUE_TIMEOUT 30
#define WEBSOCKET_SERVER_TASK_STACK_DEPTH configMINIMAL_STACK_SIZE+4096
#define WEBSOCKET_SERVER_TASK_PRIORITY tskIDLE_PRIORITY+5
#define WEBSOCKET_SERVER_PINNED 0
#if WEBSOCKET_SERVER_PINNED
#define WEBSOCKET_SERVER_PINNED_CORE 1
#endif
